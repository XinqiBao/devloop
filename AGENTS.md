...
- Be concise by removing unnecessary material, not necessary reasoning. Explain causal links and judgment boundaries plainly; use a small example when it helps. Avoid repetition, basic-tool tutorials, and fixed documentation templates.
